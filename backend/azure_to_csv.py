...
def process_images_with_model(root_folder, output_csv, threshold=0.5):
    ...
    with open(output_csv, mode='w', newline='') as csv_file:
        fieldnames = ['Section ID', 'Belt Rotation', 'Timestamp', 'Tag', 'Probability', 
                      'Bounding Box', 'Width', 'Height', 'Image Name', 'Area', 'Area Sum']
                ...
                for i, image_path in enumerate(images):
                    ...
                    for prediction in filtered_predictions:
                        ...
                        writer.writerow({
                            ...
                            'Area': area,
                            'Area Sum': areas_by_rotation[rotation_key],
                        })
